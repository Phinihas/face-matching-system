#This module implements the complete AdaFace deep learning architecture used for face 
# recognition by defining the neural network building blocks, residual backbone, attention mechanisms, 
# feature extraction pipeline, embedding generation process, weight initialization, and model factory 
# functions. It serves as the core feature extraction engine that converts an aligned face image into a 
# fixed-length normalized face embedding, which is later compared against stored embeddings in Qdrant to 
